...
void MagixCampaignManager::initialize(MagixExternalDefinitions *def, MagixGameStateManager *gameStateMgr, MagixGUI *gui, 
...
bool MagixCampaignManager::unitIsInRegion(MagixUnit *unit, const Vector2 &center, const Real &range)
{
...
void MagixCampaignManager::closeCampaign(unsigned short restartState, const String &creditsName)
{
	mGui->getChatManager()->reset(true);
	mSpawn.clear();
	mScriptedUnits.clear();
...
void MagixCampaignManager::processEvent(const CampaignEvent &cEvent, bool isInitialize, ScriptedUnit *sUnit)
{
...
const Vector2 MagixCampaignManager::parseVector2(const String &data, ScriptedUnit *sUnit)
{
	const Vector3 tVect3 = parseVector3(data, sUnit, true);
	return Vector2(tVect3.x, tVect3.z);
}
const Vector3 MagixCampaignManager::parseVector3(const String &data, ScriptedUnit *sUnit, bool isVector2)
{
...
const short MagixCampaignManager::parseItemSlot(const String &data, MagixUnit *unit)
{
